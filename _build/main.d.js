...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _bk_=
      [0,
       ...
       409934019,
       801085050],
     _o6_=caml_new_string("OCAMLRUNPARAM"),
     _o4_=caml_new_string("CAMLRUNPARAM"),
     _bl_=caml_new_string(""),
     _o3_=caml_new_string("TMPDIR"),
     _o2_=caml_new_string("TEMP"),
     ...
     _oX_=caml_new_string("State tests suite: "),
     _oY_=caml_new_string("Ai tests suite: "),
     _oR_=caml_new_string("Game"),
     _oS_=caml_new_string("lightning_spell_ai"),
     _oT_=caml_new_string("freeze_spell_ai"),
     _oU_=caml_new_string("health_spell_ai"),
     _oV_=caml_new_string("Its neutral."),
     _oW_=caml_new_string("Ai casting Lightning spell!!"),
     _oP_=caml_new_string("Game"),
     _oQ_=caml_new_string("Intro"),
     _oN_=caml_new_string("Switching to "),
     _oO_=caml_new_string("Game"),
     _oJ_=caml_new_string("Game"),
     _oK_=caml_new_string("Game Over"),
     _oL_=caml_new_string("Intro"),
     _oM_=caml_new_string("Select Difficulty"),
     _oI_=[0,caml_new_string("engine.ml"),359,58],
     _oF_=caml_new_string("}"),
     _oG_=caml_new_string(";y="),
     _oH_=caml_new_string("{x="),
     _ni_=[254,0,1,2],
     _nj_=[254,0,1,5],
     _nk_=[2,15],
     _nl_=[254,0,1,1],
     ...
     _oZ_=caml_new_string("starting main");
           ...
           {var l=param$0[2],a=param$0[1];
            try
             ...
             {_w__ = caml_wrap_exception(_w__);
              if(_w__[1] !== Sys_error)throw _w__}
            var param$0=l;
            continue}
          return 0}}
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(!(l < i))
        try
         {index_rec(s,l,i,c);var _w8_=1;return _w8_}
        catch(_w9_)
         {_w9_ = caml_wrap_exception(_w9_);
          if(_w9_ === Not_found)return 0;
          throw _w9_}
    ...
    function iter$0(f,a)
     {var _w6_=a.length - 1 - 1 | 0,_w5_=0;
      if(!(_w6_ < 0))
       {var i=_w5_;
        for(;;)
         {caml_call1(f,a[i + 1]);
    ...
    function map$0(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_w3_=l - 1 | 0,_w2_=1;
      if(!(_w3_ < 1))
       {var i=_w2_;
        for(;;)
    ...
    function fold_left$0(f,x,a)
     {var r=[0,x],_w0_=a.length - 1 - 1 | 0,_wZ_=0;
      if(!(_w0_ < 0))
       {var i=_wZ_;
        for(;;)
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _wz_=function(param){return 0},
         _wA_=function(param){return 0},
         _wB_=function(param){return 0};
        return [0,function(param){return 0},_wB_,_wA_,_wz_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _wC_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_wC_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _wD_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _wE_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _wF_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _wG_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _wH_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _wI_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _wJ_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _wK_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _wL_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _wM_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _wN_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _wO_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _wP_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _wQ_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _wR_=function(param){caml_call1(de$12,0);return 0},
           _wS_=function(param){caml_call1(ed$12,0);return 0},
           _wT_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _wU_=function(param){caml_call1(de$13,0);return 0},
           _wV_=function(param){caml_call1(ed$13,0);return 0},
           _wW_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_wg_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_wh_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_wi_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_wj_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_wk_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_wl_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_wm_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_wn_,rest2$6)];
          ...
          break;
         case 8:
          var _wo_=ty1[2],_wp_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_wq_=trans(_wo_,rest2$7);
              return [8,trans(_wp_,ty2),_wq_];
          ...
          break;
         case 9:
          var _wr_=ty1[3],_ws_=ty1[2],_wt_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_ws_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_wt_,ty22,trans(_wr_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_wu_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_wv_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_ww_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_wx_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_wy_,rest2$13)];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _wf_=match[2];
        if(typeof _wf_ !== "number" && 2 === _wf_[0])
         {var rest$0=_wf_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          var
           fmt_rest$1=fmt[2],
           pad=fmt[1],
           _vM_=type_padding(pad,fmtty),
           _vN_=_vM_[2],
           _vO_=_vM_[1];
          if(typeof _vN_ !== "number" && 1 === _vN_[0])
           {var
             fmtty_rest$1=_vN_[1],
             match$1=type_format_gen(fmt_rest$1,fmtty_rest$1),
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_vO_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _vP_=type_padding(pad$0,fmtty),
           _vQ_=_vP_[2],
           _vR_=_vP_[1];
         ...
         case 4:
          var
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _vS_=type_padprec(pad$1,prec,fmtty),
           _vT_=_vS_[3],
           _vU_=_vS_[2],
           _vV_=_vS_[1];
          if(typeof _vT_ !== "number" && 2 === _vT_[0])
           {var
             fmtty_rest$3=_vT_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_vV_,_vU_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _vW_=type_padprec(pad$2,prec$0,fmtty),
           _vX_=_vW_[3],
           _vY_=_vW_[2],
           _vZ_=_vW_[1];
          if(typeof _vX_ !== "number" && 3 === _vX_[0])
           {var
             fmtty_rest$4=_vX_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_vZ_,_vY_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _v0_=type_padprec(pad$3,prec$1,fmtty),
           _v1_=_v0_[3],
           _v2_=_v0_[2],
           _v3_=_v0_[1];
          if(typeof _v1_ !== "number" && 4 === _v1_[0])
           {var
             fmtty_rest$5=_v1_[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_v3_,_v2_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _v4_=type_padprec(pad$4,prec$2,fmtty),
           _v5_=_v4_[3],
           _v6_=_v4_[2],
           _v7_=_v4_[1];
          if(typeof _v5_ !== "number" && 5 === _v5_[0])
           {var
             fmtty_rest$6=_v5_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_v7_,_v6_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _v8_=type_padprec(pad$5,prec$3,fmtty),
           _v9_=_v8_[3],
           _v__=_v8_[2],
           _v$_=_v8_[1];
          if(typeof _v9_ !== "number" && 6 === _v9_[0])
           {var
             fmtty_rest$7=_v9_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_v$_,_v__,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _wa_=type_padding(pad$6,fmtty),
           _wb_=_wa_[2],
           _wc_=_wa_[1];
          if(typeof _wb_ !== "number" && 7 === _wb_[0])
           {var
             fmtty_rest$8=_wb_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_wc_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _wd_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_wd_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _we_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_we_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_we_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _vK_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_vK_))
             throw Type_mismatch;
            var _vL_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_vL_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _vJ_=2 === padty$0?48:32,res=make(width$0,_vJ_);
      switch(padty$0)
      ...
      for(;;)
       {if(caml_ml_string_length(str) <= i$1)
         ...
         {var match$0=caml_string_unsafe_get(str,i$1);
          if(32 <= match$0)
           {var _vH_=match$0 - 34 | 0;
            if(58 < _vH_ >>> 0)
             if(93 <= _vH_)var switch$0=0,switch$1=0;else var switch$1=1;
            else
             if(56 < (_vH_ - 1 | 0) >>> 0)
              var switch$0=1,switch$1=0;
             else
          ...
          var _vI_=switch$0?1:1}
        if(_vI_)
         {var n=[0,0],_vA_=caml_ml_bytes_length(str) - 1 | 0,_vz_=0;
          if(!(_vA_ < 0))
           {var i$0=_vz_;
            for(;;)
             {var match=caml_string_unsafe_get(str,i$0);
              if(32 <= match)
               {var _vE_=match - 34 | 0;
                if(58 < _vE_ >>> 0)
                 if(93 <= _vE_)var switch$2=0,switch$3=0;else var switch$3=1;
                else
                 if(56 < (_vE_ - 1 | 0) >>> 0)
                  var switch$2=1,switch$3=0;
                 else
                  var switch$3=1;
                if(switch$3)var _vF_=1,switch$2=2}
              else
               var switch$2=11 <= match?13 === match?1:0:8 <= match?1:0;
              switch(switch$2)
               {case 0:var _vF_=4;break;case 1:var _vF_=2;break}
              n[1] = n[1] + _vF_ | 0;
              var _vG_=i$0 + 1 | 0;
              if(_vA_ !== i$0){var i$0=_vG_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(str))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _vC_=caml_ml_bytes_length(str) - 1 | 0,_vB_=0;
            if(!(_vC_ < 0))
             {var i=_vB_;
              for(;;)
    ...
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _vy_=_ag_;break;
        case 1:var _vy_=_ah_;break;
        case 2:var _vy_=_ai_;break;
        case 3:var _vy_=_aj_;break;
        case 4:var _vy_=_ak_;break;
        case 5:var _vy_=_al_;break;
        case 6:var _vy_=_am_;break;
        case 7:var _vy_=_an_;break;
        case 8:var _vy_=_ao_;break;
        case 9:var _vy_=_ap_;break;
        case 10:var _vy_=_aq_;break;
        case 11:var _vy_=_ar_;break;
        default:var _vy_=_as_}
      return caml_format_int(_vy_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _vx_=_aG_;break;
        case 1:var _vx_=_aH_;break;
        case 2:var _vx_=_aI_;break;
        case 3:var _vx_=_aJ_;break;
        case 4:var _vx_=_aK_;break;
        case 5:var _vx_=_aL_;break;
        case 6:var _vx_=_aM_;break;
        case 7:var _vx_=_aN_;break;
        case 8:var _vx_=_aO_;break;
        case 9:var _vx_=_aP_;break;
        case 10:var _vx_=_aQ_;break;
        case 11:var _vx_=_aR_;break;
        default:var _vx_=_aS_}
      return caml_format_int(_vx_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _vw_=_aT_;break;
        case 1:var _vw_=_aU_;break;
        case 2:var _vw_=_aV_;break;
        case 3:var _vw_=_aW_;break;
        case 4:var _vw_=_aX_;break;
        case 5:var _vw_=_aY_;break;
        case 6:var _vw_=_aZ_;break;
        case 7:var _vw_=_a0_;break;
        case 8:var _vw_=_a1_;break;
        case 9:var _vw_=_a2_;break;
        case 10:var _vw_=_a3_;break;
        case 11:var _vw_=_a4_;break;
        default:var _vw_=_a5_}
      return caml_format_int(_vw_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _vv_=_at_;break;
        case 1:var _vv_=_au_;break;
        case 2:var _vv_=_av_;break;
        case 3:var _vv_=_aw_;break;
        case 4:var _vv_=_ax_;break;
        case 5:var _vv_=_ay_;break;
        case 6:var _vv_=_az_;break;
        case 7:var _vv_=_aA_;break;
        case 8:var _vv_=_aB_;break;
        case 9:var _vv_=_aC_;break;
        case 10:var _vv_=_aD_;break;
        case 11:var _vv_=_aE_;break;
        default:var _vv_=_aF_}
      return caml_int64_format(_vv_,n)}
       ...
       {if(17 <= fconv)
        ...
        if(19 <= fconv)
         {var l=caml_ml_bytes_length(s);
          if(0 === l)return s;
          var r=caml_create_bytes(l),_vp_=l - 1 | 0,_vo_=0;
          if(!(_vp_ < 0))
           {var i=_vo_;
            for(;;)
             {var c=caml_string_unsafe_get(s,i);
              if(97 <= c)
               if(122 < c)var switch$1=0;else var _vq_=c - 32 | 0,switch$1=1;
              else
               var switch$1=0;
              if(!switch$1)var _vq_=c;
              caml_string_unsafe_set(r,i,_vq_);
              var _vr_=i + 1 | 0;
              if(_vp_ !== i){var i=_vr_;continue}
              break}}
          return r}
        return s}
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _vs_=buffer_contents(buf)}
      var str=caml_format_float(_vs_,x);
      if(15 === fconv)
        ...
        for(;;)
         {if(i$0 === len)
           ...
           {var
             ...
             _vt_=match - 46 | 0,
             switch$2=
              23 < _vt_ >>> 0?55 === _vt_?1:0:21 < (_vt_ - 1 | 0) >>> 0?1:0;
            if(!switch$2){var i$1=i$0 + 1 | 0,i$0=i$1;continue}
            var _vu_=1}
          return _vu_?str:_a_(str,_a__)}}
      return str}
    function make_int_padding_precision(k,o,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _vl_=pad[2],_vm_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_vm_,_vl_,caml_call2(trans,iconv,x));
                      return make_printf(k,o,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_vm_,_vl_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,o,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_vm_,_vl_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,o,[4,acc,str],fmt)}}
        var _vn_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_vn_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_vn_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_vn_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _vh_=pad$5[2],_vi_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_vi_,_vh_,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_vi_,_vh_,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_vi_,_vh_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _vj_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_vj_,w,str);
                         return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_vj_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,o,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_vj_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _vk_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _vk_[2] === "number")
              {var fmt=_vk_[1];
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_vg_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_vg_])}}
    ...
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _vd_=[8,acc,_bf_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_vd_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_vd_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_vc_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_vc_,rest])}
    ...
    function bits(s)
     {s[2] = (s[2] + 1 | 0) % 55 | 0;
      var
       _u9_=s[2],
       curval=caml_check_bound(s[1],_u9_)[_u9_ + 1],
       _u__=(s[2] + 24 | 0) % 55 | 0,
       newval=
        caml_check_bound(s[1],_u__)[_u__ + 1]
        +
       ...
       _u$_=s[2];
      caml_check_bound(s[1],_u$_)[_u$_ + 1] = newval30;
      return newval30}
    ...
    try
     {var _o7_=caml_sys_getenv(_o6_),params=_o7_}
    catch(_u7_)
     {_u7_ = caml_wrap_exception(_u7_);
      if(_u7_ !== Not_found)throw _u7_;
      try
       {var _o5_=caml_sys_getenv(_o4_),_bm_=_o5_}
      catch(_u8_)
       {_u8_ = caml_wrap_exception(_u8_);
        if(_u8_ !== Not_found)throw _u8_;
        var _bm_=_bl_}
      var params=_bm_}
    var
        ...
        {var
         ...
         for(;;)
          {caml_check_bound(result[1],i$0)[i$0 + 1] = i$0;
           var _u5_=i$0 + 1 | 0;
           if(54 !== i$0){var i$0=_u5_;continue}
           var accu=[0,_bi_],_u1_=54 + max(55,l) | 0,_u0_=0;
           if(!(_u1_ < 0))
            {var i=_u0_;
             for(;;)
              {var
               ...
               var
                _u2_=accu[1],
                _uW_=caml_string_get(_u2_,3) << 24,
                _uX_=caml_string_get(_u2_,2) << 16,
                _uY_=caml_string_get(_u2_,1) << 8,
                _uZ_=
                 ((caml_string_get(_u2_,0) + _uY_ | 0) + _uX_ | 0)
                 +
                 _uW_
                 |
                 0,
                _u3_=
                 (caml_check_bound(result[1],j)[j + 1] ^ _uZ_)
                 &
                 1073741823;
               caml_check_bound(result[1],j)[j + 1] = _u3_;
               var _u4_=i + 1 | 0;
               if(_u1_ !== i){var i=_u4_;continue}
               break}}
           result[2] = 0;
           return result}}];
    ...
    try
     {caml_sys_getenv(_o3_)}
    catch(_uT_)
     {_uT_ = caml_wrap_exception(_uT_);if(_uT_ !== Not_found)throw _uT_}
    try
     {caml_sys_getenv(_o2_)}
    catch(_uS_)
     {_uS_ = caml_wrap_exception(_uS_);if(_uS_ !== Not_found)throw _uS_}
    var
     switch$0=
     ...
     {if(e.addEventListener === undefined$0)
       {var
         ...
         callback=
          function(e)
           {var _uP_=[0,h,e,[0]];
            return function(_uQ_,_uR_){return caml_js_call(_uP_,_uQ_,_uR_)}};
    ...
    try
     {unix_inet_addr_of_string(_o1_)}
    catch(_uN_)
     {_uN_ = caml_wrap_exception(_uN_);if(_uN_[1] !== Failure)throw _uN_}
    try
     {unix_inet_addr_of_string(_o0_)}
    catch(_uM_)
     {_uM_ = caml_wrap_exception(_uM_);if(_uM_[1] !== Failure)throw _uM_}
    create(0,7);
    function point_inside(point,pos,size)
     {var _uI_=pos[1] <= point[1]?1:0;
      if(_uI_)
       {var _uJ_=pos[2] <= point[2]?1:0;
        if(_uJ_)
         var
          _uK_=point[1] <= pos[1] + size[1]?1:0,
          _uL_=_uK_?point[2] <= pos[2] + size[2]?1:0:_uK_;
        else
         var _uL_=_uJ_}
      else
       var _uL_=_uI_;
    ...
    function add_animation_frame(param,_uH_,sprite)
     {var
       h=_uH_[2],
       w=_uH_[1],
       y=param[2],
    ...
    function color_to_hex(param)
     {var
       ...
       g=param[2],
       r=param[1],
       _uE_=caml_call1(sprintf(_e4_),a * 255 | 0),
       _uF_=_a_(caml_call1(sprintf(_e5_),b),_uE_),
       _uG_=_a_(caml_call1(sprintf(_e6_),g),_uF_);
      return _a_(_e8_,_a_(caml_call1(sprintf(_e7_),r),_uG_)).toString()}
    function draw_sprite_sheet(ctx,sprite,pos,size)
     {var _uD_=sprite[3],frame=caml_check_bound(sprite[1],_uD_)[_uD_ + 1];
      ctx.drawImage
       (sprite[2],
        frame[1][1],
        frame[1][2],
    ...
    function draw_ui(context,interface$0)
     {iter
       (function(param)
         {var ui_elmt=param[2],_uy_=ui_elmt[1];
          switch(_uy_[0])
           {case 0:
             var size=_uy_[3],pos=_uy_[2],btn_prop=_uy_[1];
             switch(btn_prop[1])
              {case 0:
             ...
             var
              _uz_=btn_prop[3][3],
              _uA_=btn_prop[3][2],
              _uB_=add_vector2d(pos,btn_prop[4]);
             draw_text(context,btn_prop[3][1],_uB_,_uA_,_uz_);
             return 0;
            case 1:
             var pos$0=_uy_[2],prop=_uy_[1];
             draw_text(context,prop[1],pos$0,prop[2],prop[3]);
             return 0;
            case 2:
             var size$0=_uy_[3],pos$1=_uy_[2],sprite=_uy_[1];
             draw_sprite_sheet(context,sprite,pos$1,size$0);
             return 0;
            default:
             var skill=_uy_[4],size$1=_uy_[3],pos$2=_uy_[2],prop$0=_uy_[1];
             switch(prop$0[1])
      ...
      for(;;)
       {if(param)
         {var
           ...
           match=param[1],
           a=match[1],
           _uw_=0 === caml_compare(a,id)?1:0;
          if(!_uw_){var param=l;continue}
          var _ux_=_uw_}
        else
         var _ux_=0;
        return _ux_?[0,assoc(id,interface$0)]:0}}
    ...
    function possible_commands(st,side)
     {var
       ...
       opp_twr_list=
        fold_left$0
         (function(acc,e){return e[9] !== side?[0,e[1],acc]:acc},_uq_,_up_),
       _ur_=st[1],
       _us_=0,
       neutral_twr_list=
        fold_left$0
         (function(acc,e){return 2 === e[9]?[0,e[1],acc]:acc},_us_,_ur_);
      ...
      if(0 < length(neutral_twr_list))
       var
        _ut_=f(side_twr_list,neutral_twr_list,0),
        indices_list=
         caml_call1
          (find_all
       ...
       var
        _uu_=f(side_twr_list,opp_twr_list,0),
        indices_list=
         caml_call1
          (find_all
            (function(param){var t=param[2],h=param[1];return h !== t?1:0}),
            ...
            if(ts_team_original === team)
             if(!caml_check_bound(st[1],start)[start + 1][12])
              {var
               ...
               var
                _t5_=0 < half?init[6] - half:init[6],
                ts=
                 [0,
                  init[1],
                  init[2],
                  ...
                  _tZ_],
                _t6_=st[1],
                start_tower=caml_check_bound(_t6_,start)[start + 1],
                end_tower=caml_check_bound(_t6_,finish)[finish + 1];
               ...
               var
                _t7_=caml_check_bound(st[1],start)[start + 1][5][3],
                _t8_=caml_check_bound(st[1],start)[start + 1][5][2],
                new_mvmt=
                 new_movement
                  (start,
                   finish,
               ...
               if(0 === l)
                ...
                {var r=caml_make_vect(l,f(0,_t9_[1])),_tX_=l - 1 | 0,_tW_=1;
                 if(!(_tX_ < 1))
                  {var i=_tW_;
                   for(;;)
                    {r[i + 1] = f(i,_t9_[i + 1]);
               ...
               var
                ...
                _ua_=st[7],
                _ub_=st[6],
                _uc_=0 === mvmt_troop_count[1]?st[5]:[0,new_mvmt,st[5]];
               return [0,
                       new_towers,
                       st[2],
                       st[3],
        ...
        if(has_enough_mana)
         {switch(skill[3][0])
           {case 0:var _ud_=0;break;
            case 1:var _ud_=0;break;
            default:
             var
              _ul_=skill[5],
              _um_=caml_check_bound(st[1],_ul_)[_ul_ + 1][9],
              _ud_=skill[1] === _um_?1:0}
          if(_ud_)return st;
          switch(skill[1])
           {case 0:
             var
              ...
              _uf_=st[8] - skill[2],
              _ug_=st[7],
              _uh_=0 === st[6]?[0,skill]:st[6];
             return [0,st[1],st[2],st[3],st[4],st[5],_uh_,_ug_,_uf_,_ue_];
            case 1:
             var
              _ui_=st[9] - skill[2],
              _uj_=st[8],
              _uk_=0 === st[7]?[0,skill]:st[7];
             return [0,st[1],st[2],st[3],st[4],st[5],st[6],_uk_,_uj_,_ui_];
            default:return st}}
        return st}}
     ...
     {var
        ...
        map
         (function(m)
           {var
             ...
             _tR_=m[8],
             _tS_=m[7],
             _tT_=m[6] + m[8] * d / distance,
             _tU_=m[5],
             _tV_=tick(m[4],d);
            return [0,m[1],m[2],m[3],_tV_,_tU_,_tT_,_tS_,_tR_]},
          _ro_),
       _rp_=st$0[9],
       _rq_=st$0[8],
       _rr_=st$0[7],
       _rs_=st$0[6],
       _rt_=caml_call1(find_all(function(m){return m[6] < 1?1:0}),mvmts),
       _ru_=st$0[4],
       _rv_=st$0[3],
       _rw_=st$0[2],
       _rx_=copy(st$0[1]),
         ...
         fold_left
          (function(acc,e)
            {if(e[6] <= 1)return acc;
             var
              _tw_=e[2],
              te=caml_check_bound(acc,_tw_)[_tw_ + 1],
              _tx_=e[5],
              _ty_=te[9];
             switch(_tx_)
              {case 0:
                if(1 === _ty_)
                 {var
                   ...
                   _tC_=te[8],
                   _tD_=te[7],
                   _tE_=0 === (new_count | 0)?0:Math.abs(new_count),
                   _tG_=e[2],
                   _tF_=
                    [0,
                     te[1],
                     ...
                     _tA_,
                     _tz_];
                  caml_check_bound(acc,_tG_)[_tG_ + 1] = _tF_;
                  var switch$0=1}
                else
                 var switch$0=0;
                break;
               case 1:
                if(0 === _ty_)
                 {var
                   ...
                   _tM_=te[8],
                   _tN_=te[7],
                   _tO_=0 === (new_count$1 | 0)?0:Math.abs(new_count$1),
                   _tQ_=e[2],
                   _tP_=
                    [0,
                     te[1],
                     ...
                     _tK_,
                     _tJ_];
                  caml_check_bound(acc,_tQ_)[_tQ_ + 1] = _tP_;
                  var switch$0=1}
                else
                 var switch$0=0;
                break;
              ...
              {var
                ...
                _tH_=
                 [0,
                  ...
                  te[11],
                  te[12]];
               caml_check_bound(acc,_tI_)[_tI_ + 1] = _tH_}
             return acc},
           _rx_,
           mvmts),
         _rw_,
      ...
      function update_skill_helper(st,d,team)
       {if(0 === team)
         {var _rF_=st[6];
          if(_rF_)
           {var sk=_rF_[1],new_towers=copy(st[1]),tower=sk[5],_rG_=sk[3];
            switch(_rG_[0])
             {case 0:
               var secs=_rG_[1];
               if(sk[7][3] <= sk[7][1])
                {if(secs <= 0)
                  {var
                    ...
                    _rM_=st[3],
                    _rN_=st[2],
                    _rO_=caml_check_bound(new_towers,tower)[tower + 1],
                    twr=
                     [0,
                      _rO_[1],
                      _rO_[2],
                   ...
                   return [0,new_towers,_rN_,_rM_,_rL_,_rK_,0,_rJ_,_rI_,_rH_]}
                 var
                  _rS_=sk[6],
                  _rP_=st[9],
                  _rQ_=st[8],
                  ...
                  _rW_=st[3],
                  _rX_=st[2],
                  _rY_=caml_check_bound(new_towers,tower)[tower + 1],
                  twr$0=
                   [0,
                    _rY_[1],
                    _rY_[2],
                 ...
                 return [0,new_towers,_rX_,_rW_,_rV_,_rU_,_rT_,_rR_,_rQ_,_rP_]}
               var
                _r2_=sk[7],
                _rZ_=st[9],
                _r0_=st[8],
                _r1_=st[7],
                _r3_=[254,sk[7][1] + sk[7][2] * d,_r2_[2],_r2_[3]],
                _r4_=tick(sk[6],d);
               return [0,
                       st[1],
                       st[2],
                       ...
                       st[4],
                       st[5],
                       [0,[0,sk[1],sk[2],sk[3],sk[4],sk[5],_r4_,_r3_]],
                       _r1_,
                       _r0_,
                       _rZ_];
              case 1:
               var incr_rate=_rG_[1];
               if(sk[7][3] <= sk[7][1])
                {var
                  _r5_=st[9],
                  _r6_=st[8],
                 ...
                 return [0,new_towers,_r$_,_r__,_r9_,_r8_,0,_r7_,_r6_,_r5_]}
               var
                _se_=sk[7],
                _sb_=st[9],
                _sc_=st[8],
                _sd_=st[7],
                _sf_=[254,sk[7][1] + sk[7][2] * d,_se_[2],_se_[3]],
                _sg_=tick(sk[6],d);
               return [0,
                       st[1],
                       st[2],
                       ...
                       st[4],
                       st[5],
                       [0,[0,sk[1],sk[2],sk[3],sk[4],sk[5],_sg_,_sf_]],
                       _sd_,
                       _sc_,
                       _sb_];
              default:
               ...
               if(sk[7][3] <= sk[7][1])
                {var
                  ...
                  _sn_=st[3],
                  _so_=st[2],
                  _sq_=caml_check_bound(st[1],_sp_)[_sp_ + 1][9],
                  _sk_=0,
                  new_troop_count=
                   sk[1] === _sq_
                  ...
                  _sv_=
                   [0,
                    ...
                    _ss_,
                    _sr_];
                 caml_check_bound(new_towers,tower)[tower + 1] = _sv_;
                 return [0,new_towers,_so_,_sn_,_sm_,_sl_,_sk_,_sj_,_si_,_sh_]}
               var
                _sz_=sk[7],
                _sw_=st[9],
                _sx_=st[8],
                _sy_=st[7],
                _sA_=[254,sk[7][1] + sk[7][2] * d,_sz_[2],_sz_[3]],
                _sB_=tick(sk[6],d);
               return [0,
                       st[1],
                       st[2],
                       ...
                       st[4],
                       st[5],
                       [0,[0,sk[1],sk[2],sk[3],sk[4],sk[5],_sB_,_sA_]],
                       _sy_,
                       _sx_,
                       _sw_]}}
          return st}
             ...
             if(sk$0[7][3] <= sk$0[7][1])
              {if(secs$0 <= 0)
                {var
                  ...
                  _sJ_=st[3],
                  _sK_=st[2],
                  _sL_=caml_check_bound(new_towers$0,tower$0)[tower$0 + 1],
                  twr$2=
                   [0,
                    _sL_[1],
                    _sL_[2],
                 ...
                 return [0,new_towers$0,_sK_,_sJ_,_sI_,_sH_,_sG_,0,_sF_,_sE_]}
               var
                _sO_=sk$0[6],
                _sM_=st[9],
                _sN_=st[8],
                ...
                _sT_=st[3],
                _sU_=st[2],
                _sV_=caml_check_bound(new_towers$0,tower$0)[tower$0 + 1],
                twr$3=
                 [0,
                  _sV_[1],
                  _sV_[2],
               ...
               return [0,new_towers$0,_sU_,_sT_,_sS_,_sR_,_sQ_,_sP_,_sN_,_sM_]}
             var
              _sY_=sk$0[7],
              _sW_=st[9],
              _sX_=st[8],
              _sZ_=[254,sk$0[7][1] + sk$0[7][2] * d,_sY_[2],_sY_[3]],
              _s0_=tick(sk$0[6],d);
             return [0,
                     st[1],
                     st[2],
                     ...
                     st[5],
                     st[6],
                     [0,[0,sk$0[1],sk$0[2],sk$0[3],sk$0[4],sk$0[5],_s0_,_sZ_]],
                     _sX_,
                     _sW_];
            case 1:
             var incr_rate$0=_sD_[1];
             if(sk$0[7][3] <= sk$0[7][1])
              {var
                _s1_=st[9],
                _s2_=st[8],
             ...
             var
              ...
              _s9_=st[9],
              _s__=st[8],
              _ta_=[254,sk$0[7][1] + sk$0[7][2] * d,_s$_[2],_s$_[3]],
              _tb_=tick(sk$0[6],d);
             return [0,
                     st[1],
                     st[2],
                     ...
                     st[5],
                     st[6],
                     [0,[0,sk$0[1],sk$0[2],sk$0[3],sk$0[4],sk$0[5],_tb_,_ta_]],
                     _s__,
                     _s9_];
            default:
             var n$0=_sD_[1];
             if(sk$0[7][3] <= sk$0[7][1])
              {var
                ...
                _ti_=st[3],
                _tj_=st[2],
                _tl_=caml_check_bound(st[1],_tk_)[_tk_ + 1][9],
                _te_=0,
                new_troop_count$0=
                 sk$0[1] === _tl_
                ...
                _tq_=
                 [0,
                  ...
                  _tn_,
                  _tm_];
               caml_check_bound(new_towers$0,tower$0)[tower$0 + 1] = _tq_;
               return [0,new_towers$0,_tj_,_ti_,_th_,_tg_,_tf_,_te_,_td_,_tc_]}
             var
              _tt_=sk$0[7],
              _tr_=st[9],
              _ts_=st[8],
              _tu_=[254,sk$0[7][1] + sk$0[7][2] * d,_tt_[2],_tt_[3]],
              _tv_=tick(sk$0[6],d);
             return [0,
                     st[1],
                     st[2],
                     ...
                     st[5],
                     st[6],
                     [0,[0,sk$0[1],sk$0[2],sk$0[3],sk$0[4],sk$0[5],_tv_,_tu_]],
                     _ts_,
                     _tr_]}}
        return st}
      var
    ...
    function contains_troops_with_team(state,team)
     {var _rm_=state[5],_rn_=0;
      return fold_left
              (function(acc,mvmt){return mvmt[5] === team?1:acc},_rn_,_rm_)}
     ...
     {var st$0=st,max_bool$0=max_bool,iters=0;
      for(;;)
       {if(100 < iters)return 0.4 + float$0(0.2);
        var _rk_=0 === st$0[3]?1:0,_rl_=_rk_ || (0 === st$0[4]?1:0);
        if(_rl_)
    ...
    function get_extreme_child(node,is_max)
     {var _rh_=node[1];
      if(0 === _rh_[0])
       ...
       var chldrn=_rh_[5],children=chldrn;
      var _ri_=caml_check_bound(children,0)[1];
      return fold_left$0
              (function(acc,child)
                {var _rj_=get_value(acc[1],is_max);
                 return caml_greaterthan(get_value(child[1],is_max),_rj_)
                         ?child
                         :acc},
               _ri_,
               children)}
           ...
           {var _re_=t[1];
            if(0 !== _re_[0])
             {var
               ...
               _rf_=t$0[1];
              if(0 !== _rf_[0]){var t=t$0;continue}
              var cm$0=_rf_[1],_rb_=t[1];
              if(0 === _rb_[0])
               var _rg_=t;
              else
               {var
    ...
    function win_pctg(node)
     {var _q__=node[1];if(0 === _q__[0])return 0;var v=_q__[3];return v}
    function run_tests(tests)
     {var test_fail=[0,0],_q8_=1;
      fold_left
       (function(acc,param)
        ...
        _q8_,
        tests);
      var _q9_=test_fail[1];
      if(_q9_){var name=_q9_[1];return _a_(_fC_,name)}
      return _fD_}
    var
     tower_base_player=
    ...
    function assert_tree_equal(t1,match)
     {if(0 === t1[0])
       {var _qV_=t1[1];
        if(0 === match[0]){var cm2=match[1];return caml_equal(_qV_,cm2)}}
      else
       {var _qW_=t1[7],_qX_=t1[6],_qY_=t1[5],_qZ_=t1[4],_q0_=t1[2],_q1_=t1[1];
        if(0 !== match[0])
         {var
           max2=match[7],
           parent2=match[6],
           ...
           cm2$0=match[2],
           st2=match[1],
           _q2_=caml_equal(_q1_,st2);
          if(_q2_)
           {var _q3_=caml_equal(_q0_,cm2$0);
            if(_q3_)
             {var _q4_=_qZ_ == n2?1:0;
              if(_q4_)
               {var _q5_=caml_equal(_qY_,chldrn2);
                if(_q5_)
                 var
                  _q6_=caml_equal(_qX_,parent2),
                  _q7_=_q6_?_qW_ === max2?1:0:_q6_;
                else
                 var _q7_=_q5_}
              else
               var _q7_=_q4_}
     ...
     _gP_=
      [0,
       [0,
        _gO_,
        function(param)
         {var _qU_=possible_commands(root_state2,0);
          return mem(get_random_command(root_state2,0),_qU_)}],
       _gN_],
     _gR_=
      [0,
       [0,
        _gQ_,
        function(param)
         {var _qT_=possible_commands(root_state2,1);
          return mem(get_random_command(root_state2,1),_qT_)}],
       _gP_],
     _gT_=
      [0,
       [0,
        _gS_,
        function(param)
         {var _qS_=possible_commands(root_state1,0);
          return mem(get_random_command(root_state1,0),_qS_)}],
       _gR_],
     _gV_=
      [0,
       [0,
        _gU_,
        function(param)
         {var _qR_=possible_commands(root_state1,1);
          return mem(get_random_command(root_state1,1),_qR_)}],
       _gT_],
     _gX_=
      [0,
       [0,
        _gW_,
        function(param)
         {var _qQ_=possible_commands(root_state0,0);
          return mem(get_random_command(root_state0,0),_qQ_)}],
       _gV_],
     tests=
      [0,
       [0,
        _gY_,
        function(param)
         {var _qP_=possible_commands(root_state0,1);
          return mem(get_random_command(root_state0,1),_qP_)}],
       _gX_],
     map_index=[0,-1],
     troop_regen_speed=1;
    function base_tower(id,team,pos)
     {switch(team)
      ...
      var _qN_=0;
      switch(team)
       {case 0:var _qO_=_gZ_;break;
        case 1:var _qO_=[254,0,-10];break;
        default:var _qO_=_g2_}
      return [0,
              id,
              pos,
              _g1_,
    ...
    function state_to_core(st)
     {var
       ...
       _qK_=st[5],
       movements_core=
        map(function(m){return [0,m[1],m[2],m[3],m[5],m[6],m[7],m[8]]},_qK_);
      return [0,
              towers_core,
              st[2],
              st[3],
    ...
    var
     ...
     _m__=
      [0,
       [0,
        _m9_,
        function(param)
         {var _qI_=caml_check_bound(state_to_core(s2_2)[1],2)[3][7];
          return caml_equal
                  (caml_check_bound(state_to_core(s1_2)[1],2)[3][7] * 5,_qI_)}],
       _m8_],
     _na_=
      [0,
       [0,
        _m$_,
        function(param)
         {var _qH_=caml_check_bound(state_to_core(s1_2)[1],2)[3][5];
          return caml_equal
                  (caml_check_bound(state_to_core(s2_2)[1],2)[3][5],_qH_)}],
       _m__],
     _nc_=
      [0,
       [0,
        _nb_,
        function(param)
         {var _qG_=caml_check_bound(state_to_core(s2_1)[1],2)[3];
          return caml_equal
                  (caml_check_bound(state_to_core(s1_2)[1],2)[3],_qG_)}],
       _na_],
     _ne_=
      [0,
     ...
     health_skill=[0,2,200,_nq_,_np_,-1,sprite_heart,_no_],
     spell_bar_player=
      [0,
       [0,
        _nD_,
    ...
    function get_scene_from_name(name)
     {return caml_string_notequal(name,_oJ_)
              ?caml_string_notequal(name,_oK_)
                ?caml_string_notequal(name,_oL_)
                  ?caml_string_notequal(name,_oM_)
                    ?intro_scene
                    :difficulty_selection_scene
                  :intro_scene
                :game_over_scene
    ...
    function main(param)
     {print_endline(_oZ_);
      ...
      if(main_gui == no_handler)throw [0,Assert_failure,_oI_];
      n.width = 1080;
      n.height = 680;
      n.id = "canvas";
      ...
      print_endline(_a_(_oX_,run_tests(tests$0)));
      print_endline(_a_(_oY_,run_tests(tests)));
      var last_move_time=[0,caml_sys_time(0)];
      switch(difficulty_level[1])
       {case 0:var base_step_length=5;break;
        case 1:var base_step_length=2.5;break;
       ...
       {var new_time=caml_sys_time(0);
        if(next_move_step[1] < new_time - last_move_time[1])
         {last_move_time[1] = new_time;
          ...
          var _pT_=current_scene[1][3];
          switch(difficulty_level[1])
           {case 0:var t$2=create_tree(_pT_,easy_iterations);break;
            case 1:var t$2=create_tree(_pT_,medium_iterations);break;
            default:var t$2=create_tree(_pT_,hard_iterations)}
          var _ps_=t$2[1];
          if(0 === _ps_[0])
           var children=[0];
          else
           var chldrn=_ps_[5],children=chldrn;
          var
           _pt_=caml_check_bound(children,0)[1],
           child=
            fold_left$0
             (function(acc,child)
               {var b=win_pctg(acc),a=win_pctg(child),_qF_=b + float$0(1e-05);
                return _qF_ < a + float$0(1e-05)?child:acc},
              _pt_,
              children),
           _pu_=child[1];
          if(0 === _pu_[0])
           var cm=_pu_[1],cm$1=cm;
          else
           var cm$0=_pu_[2],cm$1=cm$0;
          var
           ...
           _pX_=init$0[5],
           _pY_=init$0[4],
           _pZ_=new_state_plus_delta(current_scene[1][3],cm$1,delta[1]);
          current_scene[1]
          =
          [0,init$0[1],init$0[2],_pZ_,_pY_,_pX_,_pW_,_pV_,_pU_]}
        var _p0_=current_scene[1];
        if(caml_string_notequal(_p0_[1],_oR_))
         var spell_cm=0;
        else
         {var mana=_p0_[3][9],lightning_spell_ref=assoc(_oS_,_p0_[4]);
          assoc(_oT_,_p0_[4]);
          assoc(_oU_,_p0_[4]);
          var command$1=[0,0],_pP_=lightning_spell_ref[1];
          if(3 === _pP_[0])
           {var
             lightning_skill=_pP_[4],
             size$0=_pP_[3],
             pos=_pP_[2],
             spell_box_property=_pP_[1];
            if(0 === spell_box_property[1])
             {print_endline(_oV_);
              var kill_cost=lightning_skill[2];
              if(kill_cost < mana)
               {var _pQ_=lightning_skill[3];
                if(2 === _pQ_[0])var n=_pQ_[1],kill_n=n;else var kill_n=0;
                var
                 _pR_=_p0_[3][1],
                 _pS_=-1,
                 kill_index=
        ...
        var
         ...
         _p4_=init$1[5],
         _p5_=init$1[4],
         _p6_=new_state_plus_delta(current_scene[1][3],spell_cm,0);
        current_scene[1]
        =
        [0,init$1[1],init$1[2],_p6_,_p5_,_p4_,_p3_,_p2_,_p1_];
        ...
        switch(prev_mouse_state[1])
         {case 0:
          ...
          case 1:
           switch(scene$0[5][2])
            {case 0:var _pA_=0;break;
             case 1:var _pA_=2;break;
             default:var _pA_=2}
           var new_mouse_state=_pA_;
           break;
          default:
           switch(scene$0[5][2])
            {case 0:var _pB_=0;break;
             case 1:var _pB_=1;break;
             default:var _pB_=2}
           var new_mouse_state=_pB_}
        ...
        switch(scene[5][2])
         {case 0:
           var
            _py_=
             _a_(_oG_,_a_(string_of_float(current_scene[1][5][1][2]),_oF_));
           print_endline
            (_a_(_a_(_oH_,string_of_float(current_scene[1][5][1][1])),_py_));
           break;
          case 1:break
          }
        var _p7_=current_scene[1][5],_p8_=current_scene[1][4];
        iter
         (function(param)
           {var uref=param[2],_qE_=uref[1];
            switch(_qE_[0])
             {case 0:
               var nsc=_qE_[4],size=_qE_[3],pos=_qE_[2],prop=_qE_[1];
               if(0 === prop[1])return 0;
               if(point_inside(_p7_[1],pos,size))
                if(1 === _p7_[2])
                 prop[1] = 3;
                else
                 {var switch$0=0 === _p7_[2]?0:2 === prop[1]?0:1;
               ...
               return 0;
              case 1:
               var size$0=_qE_[3],pos$0=_qE_[2],label_prop=_qE_[1];
              ...
              default:return 0}},
          _p8_);
        current_scene[1][4] = _p8_;
        if(0 < length(current_scene[1][2]))
         if(0 === hd(current_scene[1][2]))
          {var _p9_=current_scene[1],_pe_=_p9_[1];
           if(caml_string_notequal(_pe_,_fp_))
            if(caml_string_notequal(_pe_,_fq_))
             var
              _pf_=_p9_[4],
              _pg_=0,
              next_scene_id=
               fold_left
                (function(acc,param)
                  {var ui_ref=param[2],_qA_=ui_ref[1];
                   if(0 === _qA_[0])
                    {var _qB_=_qA_[4];
                     if(_qB_)
                      {var scid=_qB_[1],bprop=_qA_[1];
             ...
             var
              ...
              next_scene_id=
               fold_left
                (function(acc,param)
                  {var ui_ref=param[2],id=param[1],_qC_=ui_ref[1];
                   if(0 === _qC_[0])
                    {var _qD_=_qC_[4];
                     if(_qD_)
                      {var scid=_qD_[1],bprop=_qC_[1];
                       if(3 === bprop[1])
                        {difficulty_level[1]
                         =
            ...
            {if(0 === _p9_[3][3])
              if(contains_troops_with_team(_p9_[3],0))
               var switch$1=0;
              else
             ...
             if(!switch$1)
              {if(0 === _p9_[3][4])
                if(contains_troops_with_team(_p9_[3],1))
                 var switch$2=0;
                else
           ...
           if(next_scene_id)
            {var nxt=next_scene_id[1];
             print_endline(_a_(_oN_,nxt));
             if(caml_string_equal(nxt,_oO_))
              if(-1 === map_index[1])
               var switch$3=0;
              else
               var
                ...
                tasks=
                 [0,
                  [0,4,caml_check_bound(maps,_px_)[_px_ + 1][2]],
             ...
             var
              ...
              _pG_=init[4],
              _pH_=init[3],
              _pI_=append(tasks,[0,[3,nxt],0]);
             current_scene[1] = [0,init[1],_pI_,_pH_,_pG_,_pF_,_pE_,_pD_,_pC_]}
           var
            _p__=current_scene[1][5],
            _p$_=current_scene[1],
            _pn_=_p$_[3][1],
            updated_towers=
             map$0
              (function(t)
           ...
           iter
            (function(param)
              {var uref=param[2],_qo_=uref[1];
               if(3 === _qo_[0])
                {var skill=_qo_[4],size=_qo_[3],pos=_qo_[2],prop=_qo_[1];
                 if(2 === prop[1])
                  {var
                    _qp_=skill[4],
                    timer=
                     [254,skill[4][1] + delta[1] * skill[4][2],_qp_[2],_qp_[3]];
                   if(timer[3] <= timer[1])
                  ...
                  if((_p$_[3][8] | 0) < skill[2])
                   {prop[1] = 3;uref[1] = [3,prop,pos,size,skill]}
                  else
                   {var
                     switch$0=
                      0 === prop[1]
                       ?point_inside(_p__[1],pos,size)
                         ?0 === _p__[2]
                        ...
                        {var
                          ...
                          tidopt=
                           fold_left$0
                            (function(acc,t)
                              {return 0 === acc
                                       ?point_inside(_p__[1],t[2],t[3])?[0,t[1]]:0
                                       :acc},
                             _qn_,
                             _qq_);
                         if(tidopt)
           ...
           switch(_p__[2])
            {case 0:
              ...
              iter$0
               (function(t)
                 {return point_inside(_p__[1],t[2],t[3])
                          ?(_p$_[6] = [0,t[1],_p$_[6]],destination[2] = [0,t[1]],0)
                          :0},
                _pk_);
              break;
             case 1:
              ...
              iter$0
               (function(t)
                 {if(point_inside(_p__[1],t[2],t[3]))
                   {destination[1] = [0,t[1]];
                    var _ql_=destination[2],_qm_=destination[1];
                    if(_ql_)
                     if(_qm_)
                      {var b=_qm_[1],a=_ql_[1];command$0[1] = [0,0,a,b];return 0}
                    return 0}
                  return 0},
                _pm_);
              destination[2] = 0;
           ...
           var
            _pl_=command$0[1],
            pmana=update_mana(_p$_[3],0),
            emana=update_mana(_p$_[3],1),
            _po_=_p$_[3],
            state=
             [0,
              updated_towers,
              ...
              pmana,
              emana],
            ans_state=new_state_plus_delta(state,_pl_,delta[1]),
            match$0=find_ui_ref(_p$_[4],_fw_);
           if(match$0)
            {var ref_fps_label=match$0[1],_pp_=caml_new_string("" + fps[1]);
             get_label_prop(ref_fps_label[1])[1] = _pp_}
           var match$1=find_ui_ref(_p$_[4],_fx_);
           if(match$1)
            {var
              ref_mana_label=match$1[1],
              _pq_=_a_(_fy_,caml_new_string("" + (_p$_[3][8] | 0)));
             get_label_prop(ref_mana_label[1])[1] = _pq_}
           var match$2=find_ui_ref(_p$_[4],_fz_);
           if(match$2)
            {var
              ref_mana_label$0=match$2[1],
              _pr_=_a_(_fA_,caml_new_string("" + (_p$_[3][9] | 0)));
             get_label_prop(ref_mana_label$0[1])[1] = _pr_}
        ...
        draw_sprite_sheet(context,_qa_[8],_fd_,[254,width,height]);
        var _o8_=_qa_[3][5];
        iter
         (function(mvmt)
           {if(!(0.975 < mvmt[6]))
             if(!(mvmt[6] < 0.025))
              {var
                ...
                ts_index=mvmt[1],
                te_index=mvmt[2],
                ts=caml_check_bound(_qk_[1],ts_index)[ts_index + 1],
                te=caml_check_bound(_qk_[1],te_index)[te_index + 1],
                progress=mvmt[6],
                start_vector=add_vector2d(ts[2],ts[10]),
                end_vector=add_vector2d(te[2],te[10]),
                _qi_=scalar_mult_vector2d(progress,end_vector),
                _qj_=
                 add_vector2d
                  (scalar_mult_vector2d(1 - progress,start_vector),_qi_),
                vec=add_vector2d([254,0,-1 * size[2] / 2],_qj_),
                x=vec[1] + 25 - 15,
                y=vec[2] + 10;
        ...
        iter$0
         (function(t)
           {var param=_qa_[6],_qd_=t[1];
            for(;;)
             {if(param)
               {var l=param[2],a=param[1],_qc_=0 === caml_compare(a,_qd_)?1:0;
                if(!_qc_){var param=l;continue}
                var _qe_=_qc_}
              else
               var _qe_=0;
              if(_qe_)
               {var
                 _qf_=[254,t[3][1] * 2,t[3][1]],
                 _qg_=add_vector2d(t[10],t[2]);
                draw_sprite_sheet
                 (context,
                  tower_highlight,
                  add_vector2d([254,-1 * (t[3][1] / 2),-25],_qg_),
                  _qf_)}
              ...
              var
               ...
               color=match[1],
               _qh_=t[4],
               spr=[0,_qh_[1],_qh_[2],index,_qh_[4],_qh_[5]];
        ...
        if(_o__)
         {var
           skl=_o__[1],
           _o$_=skl[5],
           tower=caml_check_bound(_qa_[3][1],_o$_)[_o$_ + 1];
        ...
        if(_pa_)
         {var
           skl$0=_pa_[1],
           _pb_=skl$0[5],
           tower$0=caml_check_bound(_qa_[3][1],_pb_)[_pb_ + 1];
          draw_sprite_sheet(context,skl$0[6],tower$0[2],tower$0[3])}
        draw_ui(context,_qa_[4]);
        var _qb_=current_scene[1],_pc_=_qb_[2];
        if(_pc_)
         {var _pd_=_pc_[1];
          if(typeof _pd_ === "number")
           ...
           switch(_pd_[0])
            {case 3:var switch$4=0;break;
             case 0:
              var t=_pc_[2],interface$1=_pd_[2],time$0=_pd_[1];
              _qb_[2] = 0 < time$0?[0,[0,time$0 - delta[1],interface$1],t]:t;
              var switch$4=1;
              break;
             case 1:
              var t$0=_pc_[2],amag$1=_pd_[3],lim$1=_pd_[2],cur$1=_pd_[1];
              if(lim$1 <= cur$1)
               _qb_[2] = t$0;
              else
               {var cur$2=cur$1 + delta[1] * 1;
                _qb_[2] = [0,[1,cur$2,lim$1,amag$1],t$0]}
              var switch$4=1;
              break;
             default:
              var t$1=_pc_[2],amag$2=_pd_[3],lim$2=_pd_[2],cur$3=_pd_[1];
              if(lim$2 <= cur$3)
               _qb_[2] = t$1;
              else
               {var cur$4=cur$3 + delta[1] * 1;
                _qb_[2] = [0,[2,cur$4,lim$2,amag$2],t$1]}
              var switch$4=1}}
        else
         {print_endline(_fi_);_qb_[2] = _fj_}
        if(0 < length(_qb_[2]))
         {var match=hd(_qb_[2]);
          if(typeof match !== "number")
           switch(match[0])
        ...
        if(0 < length(current_scene[1][2]))
         {var match$3=hd(current_scene[1][2]);
          if(typeof match$3 === "number")
           ...
           if(3 === match$3[0])
            {var nxt$0=match$3[1];
             if(caml_string_equal(nxt$0,_oP_))
              if((maps.length - 1 - 1 | 0) <= map_index[1])
               {var next_scene=get_scene_from_name(_oQ_);
                current_scene[1] = next_scene;
                var _pJ_=current_scene[1];
                current_scene[1]
                =
                [0,
                 _pJ_[1],
               ...
               {var
                ...
                var
                 _pv_=map_index[1],
                 _pw_=caml_check_bound(maps,_pv_)[_pv_ + 1][1];
                current_scene[1]
                =
                [0,game_scene[1],[0,fade_in,0],_pw_,_pO_,_pN_,_pM_,_pL_,_pK_]}
             else
              {map_index[1] = -1;
