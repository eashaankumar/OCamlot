...
**************************************************************/
    ...
    // Sets a block level element's display property to "none"
	  ...
	  function hide(divid, curtxt, newtxt) {
	    ...
	    if (!divid.startsWith("comments") && !divid.startsWith("removedcomments")) {
    ...
    function setEdit(){
    	var parameter = getElementById('edit'); // RequestParam.Course.EDIT
    	parameter.value = 'true'; // RequestParam.TRUE
		return false;
    }
    ...
    function rollOver(rollURL, buttonID, aTag, confirmDialog) {
	   if (aTag==undefined) {
	      aTag="";
	   }
	   ...
	   var part01= " <a onmouseover=\"if (document.images) document.",
	       ...
	       part09= "  href=\"",
	       part10= rollURL + "\"",
	       part11= (confirmDialog=="") ? "":" onClick=\"return confirm(\'" + confirmDialog + "\')\"",
	       part12="><img src=",
	       part13= "\"" + image_off + "\"",
	       part14= "name=\"",
	       part15= "rollID"+rollNum,
	       part16="\" border=0></a>";
...
/**
 * addLoadEvent(func)
 * Adds a window on-load event
 * Note: Works for Mozilla, Gecko, Safari, IE6+, Opera 7
 */
